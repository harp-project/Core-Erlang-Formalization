...
module CoqExtractionReplaced where
...
pids_map_set_union = (\f m -> Data.HashSet.unions [f k v | (k, v) <- Data.HashMap.Strict.toList m])
...
pool_domain = Data.HashMap.Strict.keysSet
...
ether_domain_toList = (\eth -> Data.HashSet.toList (Data.HashMap.Strict.keysSet eth))
