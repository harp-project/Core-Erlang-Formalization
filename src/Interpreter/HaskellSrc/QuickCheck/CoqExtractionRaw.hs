    ...
    case x0 of {
     ...
     (:) a0 l0 ->
      sumbool_rec (\_ ->
        ...
        Prelude.False) (eq_dec4 a a0)}) l l'
     ...
     (,) a0 b0 ->
      sumbool_rec (\_ ->
        sumbool_rec (\_ -> Prelude.True) (\_ -> Prelude.False)
          (decide_rel eqDecision1 b b0)) (\_ -> Prelude.False)
        (decide_rel eqDecision0 a a0)}) x y
...
prod_countable eqDecision0 h eqDecision1 h0 =
  Build_Countable (\xy ->
    prod_encode (encode eqDecision0 h (Prelude.fst xy))
      (encode eqDecision1 h0 (Prelude.snd xy))) (\p ->
...
nat_countable =
  Build_Countable (\x -> encode eq_dec3 n_countable (of_nat x)) (\p ->
    fmap (unsafeCoerce (\_ _ -> option_fmap)) to_nat0
        ...
        case pat of {
         (,) _ x0 ->
          fmap (unsafeCoerce (\_ _ -> option_fmap)) (\x1 -> (,) __ x1)
            (unsafeCoerce f x0)}) (unsafeCoerce mx))
  ...
  Build_Countable (\m ->
    encode (list_eq_dec0 (prod_eq_dec eqDecision0 eqDecision1))
      (list_countable (prod_eq_dec eqDecision0 eqDecision1)
        (prod_countable eqDecision0 h eqDecision1 h0))
      (map_to_list (\_ -> gmap_fold eqDecision0 h) m)) (\p ->
    fmap (unsafeCoerce (\_ _ -> option_fmap))
      ...
      (decode
        ...
        (unsafeCoerce list_countable (prod_eq_dec eqDecision0 eqDecision1)
          (prod_countable eqDecision0 h eqDecision1 h0)) p))
...
pids_fresh pids =
  fresh
    (set_fresh (gset_elements eq_dec1 nat_countable)
      (infinite_fresh nat_infinite)) pids
...
ether_lookup pids eth =
  lookup
    (gmap_lookup (prod_eq_dec eq_dec1 eq_dec1)
      (prod_countable eq_dec1 nat_countable eq_dec1 nat_countable)) pids eth
  ...
  insert
    (map_insert0
      (gmap_partial_alter (prod_eq_dec eq_dec1 eq_dec1)
        (prod_countable eq_dec1 nat_countable eq_dec1 nat_countable))) pids
    sigs eth
...
ether_toList eth =
  map_to_list (\_ ->
    gmap_fold (prod_eq_dec eq_dec1 eq_dec1)
      (prod_countable eq_dec1 nat_countable eq_dec1 nat_countable)) eth
...
usedPIDsProcNew p =
  case p of {
   ...
   Prelude.Right links ->
    pids_map_set_union (\k x -> pids_insert k (usedPIDsValNew x)) links}
                   ...
                   Prelude.Just p' -> Prelude.Just ((,) ((,) ((,) eth
                    (pool_insert freshPID (Prelude.Left ((,) ((,) ((,) ((,)
                      ...
                      (case link_flag of {
                        Prelude.True -> pids_singleton pid;
                        Prelude.False -> pids_empty})) Prelude.False))
                      (pool_insert pid p' prs))) a) (Prelude.succ hiPID));
                   Prelude.Nothing -> Prelude.Nothing}};
               Prelude.Nothing -> Prelude.Nothing};
             Prelude.Nothing -> Prelude.Nothing};
           _ ->
