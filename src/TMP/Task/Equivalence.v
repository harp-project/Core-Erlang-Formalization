...
(*use flatten_deflatten*)
Search deflatten_list flatten_list.
  Theorem val_map_flatten_id :
    forall (vl : list (Val * Val)),
      make_val_map ((deflatten_list (flatten_list vl))) = vl.
  Proof.
    intros.
  Admitted.

  Theorem bs_to_fs_val_reduction_old :
    ...
    * (* #6 VMap *)
      ...
      - (* #6.2 Induction step *)
        ...
        assert (create_result IMap ([v1'] ++ v2' :: _fvl') [] = Some (_r, [])) as Hr.
        {
          ...
          inv Heq_r.
          clear H.
          pose proof val_map_flatten_id as Hid.
          specialize (Hid vl').
          rewrite Hid.
