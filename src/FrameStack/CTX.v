...
| CCallMod (c : Ctx) (f : Exp) (l : list Exp)
| CCallFun (m : Exp) (c : Ctx) (l : list Exp)
| CCallParam (m f : Exp)    (l : list Exp) (c : Ctx) (l' : list Exp)
...
| CCallMod c f l     => EExp ( ECall (plug c p) f l )
| CCallFun m c l     => EExp ( ECall m (plug c p) l )
| CCallParam   m f l c l'
                     => EExp ( ECall m f (l ++ [(plug c p)] ++ l') )
...
| CEScope_CCallParam : forall Γ m f l c l',
  EXP Γ ⊢ m ->
  EXP Γ ⊢ f ->
  Forall (fun e => EXP Γ ⊢ e) l ->
  EECTX Γh ⊢ c ∷ Γ ->
  Forall (fun e => EXP Γ ⊢ e) l' ->
  EECTX Γh ⊢ (CCallParam m f l c l') ∷ Γ
...
Proof.
  ...
  * do 2 constructor. apply indexed_to_forall. exact H7.
    all: auto.
  * do 2 constructor. apply indexed_to_forall. exact H7.
    all: auto.
  * do 2 constructor. apply indexed_to_forall.
...
Proof.
  ...
  { clear H0 H1.
    ...
    - apply RValues.
      ...
      apply biforall_app. 2: constructor.
      + apply forall_biforall_refl, Forall_forall. intros.
        rewrite Forall_forall in H5. apply Rrefl. now apply H5 in H0.
      + apply IHC; auto.
      + apply forall_biforall_refl, Forall_forall. intros.
        rewrite Forall_forall in H7. apply Rrefl. now apply H7 in H0.
    - apply RCons; auto.
      + eapply @plug_preserves_scope_exp with (e := e1) in H4; eauto 2.
      + eapply @plug_preserves_scope_exp with (e := e2) in H4; eauto 2.
    - apply RCons; auto.
    ...
    - apply RMap; auto.
      1-2: apply Forall_app; split; auto; constructor; auto.
      1-2: split; simpl; try eapply plug_preserves_scope_exp; eauto.
      apply biforall_app. 2: constructor.
      + apply forall_biforall_refl, Forall_forall. intros.
        rewrite Forall_forall in H6. destruct x; split;
        apply Rrefl; apply H6 in H0; now destruct H0.
      + split; auto.
      + apply forall_biforall_refl, Forall_forall. intros.
        rewrite Forall_forall in H7. destruct x; split;
        apply Rrefl; apply H7 in H0; now destruct H0.
    - apply RMap; auto.
      1-2: apply Forall_app; split; auto; constructor; auto.
      1-2: split; simpl; try eapply plug_preserves_scope_exp; eauto.
      apply biforall_app. 2: constructor.
    ...
    - apply RCall; auto.
      1-2: apply Forall_app; split; auto; constructor; auto.
      1-2: simpl; try eapply plug_preserves_scope_exp; eauto.
      apply biforall_app. 2: constructor.
      + apply forall_biforall_refl, Forall_forall. intros.
      ...
      + apply forall_biforall_refl, Forall_forall. intros.
        ...
        apply Rrefl. now apply H11 in H0.
    - apply RPrimOp; auto.
      1-2: apply Forall_app; split; auto; constructor; auto.
      1-2: simpl; try eapply plug_preserves_scope_exp; eauto.
      apply biforall_app. 2: constructor.
      + apply forall_biforall_refl, Forall_forall. intros.
        ...
        apply Rrefl. now apply H5 in H0.
      + now apply IHC.
      + apply forall_biforall_refl, Forall_forall. intros.
        rewrite Forall_forall in H8.
        apply Rrefl. now apply H8 in H0.
    - apply RApp; auto.
      + eapply @plug_preserves_scope_exp with (e := e1) in H4; eauto 2.
      + eapply @plug_preserves_scope_exp with (e := e2) in H4; eauto 2.
      + apply forall_biforall_refl.
    ...
    - apply RApp; auto.
      ...
      + apply forall_biforall_refl, Forall_forall. intros.
        ...
        apply Rrefl. now apply H7 in H0.
      + now apply IHC.
      + apply forall_biforall_refl, Forall_forall. intros.
        rewrite Forall_forall in H9.
        apply Rrefl. now apply H9 in H0.
