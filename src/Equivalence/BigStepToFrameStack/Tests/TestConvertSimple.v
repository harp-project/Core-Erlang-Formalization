...
From CoreErlang.Equivalence.BigStepToFrameStack Require Import SubstituteSimple.
...
Qed.
  ˝ Syntax.VNil
*)
Compute bexp_to_fexp (fun _ => 0) 
                     (bval_to_bexp (subst_env 100) 
                                 VNil).
...
(* VVal *)
Compute fexp_to_fval (˝ Syntax.VNil).
Compute fexp_to_fval (˝ Syntax.VLit 1%Z).
Compute fexp_to_fval (˝ Syntax.VPid 1).
Compute fexp_to_fval (˝ Syntax.VCons (Syntax.VLit 1%Z) (Syntax.VNil)).
Compute fexp_to_fval (˝ Syntax.VTuple [Syntax.VLit 1%Z; Syntax.VNil]).
Compute fexp_to_fval (˝ Syntax.VMap [(Syntax.VLit 1%Z, Syntax.VNil)]).
Compute fexp_to_fval (˝ Syntax.VVar 0).
Compute fexp_to_fval (˝ Syntax.VFunId (0 , 0)).
Compute fexp_to_fval (˝ Syntax.VClos [] 0 0 (˝ Syntax.VLit 1%Z)).

(* VExp *)
Compute fexp_to_fval (° Syntax.EFun 0 (˝ Syntax.VLit 1%Z)).
Compute fexp_to_fval (° Syntax.EValues [˝ Syntax.VLit 1%Z; ˝ Syntax.VNil]).
Compute fexp_to_fval (° Syntax.ECons (˝ Syntax.VLit 1%Z) (˝ Syntax.VNil)).
Compute fexp_to_fval (° Syntax.ETuple [˝ Syntax.VLit 1%Z; ˝ Syntax.VNil]).
Compute fexp_to_fval (° Syntax.EMap [(˝ Syntax.VLit 1%Z, ˝ Syntax.VNil)]).
Compute fexp_to_fval (° Syntax.ECall (˝ Syntax.VLit 1%Z) (˝ Syntax.VLit 1%Z) [˝ Syntax.VNil]).
Compute fexp_to_fval (° Syntax.EPrimOp "" [˝ Syntax.VLit 1%Z; ˝ Syntax.VNil]).
Compute fexp_to_fval (° Syntax.EApp (˝ Syntax.VLit 1%Z) [˝ Syntax.VNil]).
Compute fexp_to_fval (° Syntax.ECase (˝ Syntax.VLit 1%Z) [([], ˝ Syntax.VLit 1%Z, ˝ Syntax.VLit 1%Z)]).
Compute fexp_to_fval (° Syntax.ELet 0 (˝ Syntax.VLit 1%Z) (˝ Syntax.VVar 0)).
Compute fexp_to_fval (° Syntax.ESeq (˝ Syntax.VLit 1%Z) (˝ Syntax.VLit 1%Z)).
Compute fexp_to_fval (° Syntax.ELetRec [(0, (˝ Syntax.VLit 1%Z))] (˝ Syntax.VVar 0)).
Compute fexp_to_fval (° Syntax.ETry (˝ Syntax.VLit 1%Z) 0 (˝ Syntax.VLit 1%Z) 0 (˝ Syntax.VLit 1%Z)).
