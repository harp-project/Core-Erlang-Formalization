...
Definition side_exception_exp (a : Z) (s : string) : Expression := ELet
   ["X"%string] (ECall "io" "fwrite" [ELit (Atom s)])
      (EApp (ELit (Integer a)) []).
...
Example eval_list_tail_fbs :
  fbs_expr 1000 [] 0 (ECons (ECall "io" "fwrite" [ELit (Atom "a")]) (ELet
   ["X"%string] (ECall "io" "fwrite" [ELit (Atom "b")])
      (EApp (ELit (Integer 0)) []))) []
=
...
Example eval_list_tail :
  | [], 0, ECons (ECall "io" "fwrite" [ELit (Atom "a")]) (ELet
   ["X"%string] (ECall "io" "fwrite" [ELit (Atom "b")])
      (EApp (ELit (Integer 0)) [])), []|
-e>
...
Example eval_list_head_fbs :
  fbs_expr 1000 [] 0 (ECons (EApp (ELit (Integer 0)) []) (ECall "io" "fwrite" [ELit (Atom "a")])) [] 
=
...
Example eval_list_head :
  | [], 0, ECons (EApp (ELit (Integer 0)) []) (ECall "io" "fwrite" [ELit (Atom "a")]), []| 
-e>
...
Example eval_tuple_s_e_fbs :
  fbs_expr 1000 [] 0 (ETuple [ECall "io" "fwrite" [ELit (Atom "a")]; ELet
   ["X"%string] (ECall "io" "fwrite" [ELit (Atom "b")])
      (EApp (ELit (Integer 0)) [])]) []
=
...
Example eval_tuple_s_e :
  | [], 0, ETuple [ECall "io" "fwrite" [ELit (Atom "a")]; ELet
   ["X"%string] (ECall "io" "fwrite" [ELit (Atom "b")])
      (EApp (ELit (Integer 0)) [])], []|
-e>
...
Example eval_try_s_e_fbs :
  fbs_expr 1000 [] 0 (ETry (ECall "io" "fwrite" [ELit (Atom "a")]) ["X"%string] 
  (ELet
     ["X"%string] (ECall "io" "fwrite" [ELit (Atom "b")])
       (EApp (ELit (Integer 0)) [])) 
...
Example eval_try_s_e :
  | [], 0, ETry (ECall "io" "fwrite" [ELit (Atom "a")]) ["X"%string] 
  (ELet
     ["X"%string] (ECall "io" "fwrite" [ELit (Atom "b")])
       (EApp (ELit (Integer 0)) [])) 
  ["Ex1"%string; "Ex2"%string; "Ex3"%string]
...
Example eval_catch_fbs :
  fbs_expr 1000 [] 0 (ETry (ELet
   ["X"%string] (ECall "io" "fwrite" [ELit (Atom "a")])
      (EApp (ELit (Integer 0)) [])) ["X"%string]
   (ECall "io" "fwrite" [ELit (Atom "a")]) 
   ["Ex1"%string; "Ex2"%string; "Ex3"%string]
   (ECall "io" "fwrite" [ELit (Atom "c")])) []
=
...
Example eval_case_pat_fbs :
  fbs_expr 1000 [] 0 (ECase (ELet
   ["X"%string] (ECall "io" "fwrite" [ELit (Atom "a")])
      (EApp (ELit (Integer 0)) []))
                 [([PVar "X"%string], ELit (Atom "true"), ECall "io" "fwrite" [ELit (Atom "b")])])
  []
=
  Result 0 (inr (badfun (VLit (Integer 0)))) [(Output, [VLit (Atom "a")])].
Proof.
...
Example eval_case_clause_fbs :
  fbs_expr 1000 [(inl "Y"%string, VLit (Integer 2))] 0
     (ECase (ELet ["X"%string] (ECall "io" "fwrite" [ELit (Atom "a")]) (EVar "Y"%string))
          [([PLit (Integer 1)], ELit (Atom "true"), ECall "io" "fwrite" [ELit (Atom "b")]); 
           ([PVar "Z"%string], ELit (Atom "false"), ECall "io" "fwrite" [ELit (Atom "c")])])
  []
=
...
Example eval_call_s_e_fbs :
  fbs_expr 1000 [] 0 (ECall "io" "fwrite" [ECall "io" "fwrite" [ELit (Atom "a")]; EApp (ELit (Integer 0)) []]) []
=
  Result 0 (inr (badfun (VLit (Integer 0)))) [(Output, [VLit (Atom "a")])].
Proof.
  auto.
...
Example eval_call_s_e :
  | [], 0, ECall "io" "fwrite" [ECall "io" "fwrite" [ELit (Atom "a")]; EApp (ELit (Integer 0)) []], []|
-e>
  | 0, inr (badfun (VLit (Integer 0))), [(Output, [VLit (Atom "a")])]|.
Proof.
  solve.
...
Example eval_apply_param_fbs :
  fbs_expr 1000 [] 0 (EApp (ECall "io" "fwrite" [ELit (Atom "a")]) [ELet
   ["X"%string] (ECall "io" "fwrite" [ELit (Atom "b")])
      (EApp (ELit (Integer 0)) [])]) []
=
  Result 0 (inr (badfun (VLit (Integer 0))))
...
Example eval_apply_param :
  | [], 0, EApp (ECall "io" "fwrite" [ELit (Atom "a")]) [ELet
   ["X"%string] (ECall "io" "fwrite" [ELit (Atom "b")])
      (EApp (ELit (Integer 0)) [])], []|
-e>
  | 0, inr (badfun (VLit (Integer 0))), 
...
Example eval_apply_closure_fbs :
  fbs_expr 1000 [] 0 (EApp (ECall "io" "fwrite" [ELit (Atom "a")]) [ECall "io" "fwrite" [ELit (Atom "b")]]) []
=
...
Example eval_apply_closure :
  | [], 0, EApp (ECall "io" "fwrite" [ELit (Atom "a")]) [ECall "io" "fwrite" [ELit (Atom "b")]], []|
-e>
...
Example eval_apply_param_len_fbs :
  fbs_expr 1000 [(inl "X"%string, VClos [] [] 0 [] (ELit (Integer 5)))] 1
    (EApp (EVar "X"%string) [ECall "io" "fwrite" [ELit (Atom "a")]]) []
=
...
Example eval_map_key_fbs:
  fbs_expr 1000 [] 0 
      (EMap [(ECall "io" "fwrite" [ELit (Atom "a")], ECall "io" "fwrite" [ELit (Atom "b")]);
                 (ELet
   ["X"%string] (ECall "io" "fwrite" [ELit (Atom "c")])
      (EApp (ELit (Integer 0)) []), ECall "io" "fwrite" [ELit (Atom "d")])])
  []
=
  Result 0 (inr (badfun (VLit (Integer 0))))
       [(Output, [VLit (Atom "a")]); (Output, [VLit (Atom "b")]); 
...
Example eval_map_key:
  | [], 0, EMap [(ECall "io" "fwrite" [ELit (Atom "a")], ECall "io" "fwrite" [ELit (Atom "b")]);
                 (ELet
   ["X"%string] (ECall "io" "fwrite" [ELit (Atom "c")])
      (EApp (ELit (Integer 0)) []), ECall "io" "fwrite" [ELit (Atom "d")])]
  , []|
...
Example eval_map_value_fbs:
  fbs_expr 1000 [] 0 
          (EMap [(ECall "io" "fwrite" [ELit (Atom "a")], ECall "io" "fwrite" [ELit (Atom "b")]);
                 (ECall "io" "fwrite" [ELit (Atom "c")], ELet
   ["X"%string] (ECall "io" "fwrite" [ELit (Atom "d")])
      (EApp (ELit (Integer 0)) []))])
  []
=
  Result 0 (inr (badfun (VLit (Integer 0))))
...
Example seq_eval_ex_2 :
  | [], 0, ESeq (ECall "io" "fwrite" [ELit (Atom "a")])
                (ESeq (ELet
   ["X"%string] (ECall "io" "fwrite" [ELit (Atom "b")])
      (EApp (ELit (Integer 0)) []))
                      (ECall "io" "fwrite" [ELit (Atom "c")]))
