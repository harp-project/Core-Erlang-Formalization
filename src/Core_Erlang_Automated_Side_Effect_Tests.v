...
Example tuple_eff :
  |[], 0, ETuple [ECall "io" "fwrite" [ELit (Atom "a")];
               ECall "io" "fwrite" [ELit (Atom "b")];
               ECall "io" "fread" [ELit (Atom "") ; ELit (Atom "c")]], []|
-e>
...
Example list_eff :
  |[], 0, ECons (ECall "io" "fwrite" [ELit (Atom "a")])
             (ECons (ECall "io" "fwrite" [ELit (Atom "b")]) ENil), []|
-e> 
...
Example case_eff : 
  |[], 0, ECase (ECall "io" "fwrite" [ELit (Atom "a")])
      [([PVar "X"], ELit (Atom "false"), (ECall "io" "fwrite" [ELit (Atom "b")])); 
       ([PLit (Integer 5)], ELit (Atom "true"), ELit (Integer 2)); 
       ([PVar "Y"], ELit (Atom "true"), (ECall "io" "fwrite" [ELit (Atom "c")]))]
  , []|
...
Example call_eff :
  |[], 0, ECall "io" "fwrite" [ECall "io" "fwrite" [ELit (Atom "a")]], []|
-e>
...
Example apply_eff : 
  |[(inl "Y", VClos [] [] 0 ["Z"] (ECall "io" "fwrite" [ELit (Atom "c")]))], 1, 
    EApp (ELet ["X"] (ECall "io" "fwrite" [ELit (Atom "a")]) 
             (EVar "Y"))
           [ECall "io" "fwrite" [ELit (Atom "b")] ], []|
-e>
...
Example letrec_eff : 
  |[], 0, ELetRec [(("f1", 0), ([], ECall "io" "fwrite" [ELit (Atom "a")]))]
           (EApp (EFunId ("f1", 0)) []), []|
-e>
