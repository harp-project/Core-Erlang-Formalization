...
(** Semantic domain *)
Definition ValueSequence := list ValueExpression.

(** For biuilt-in arithmetic calls *)
Definition eval_arith (fname : string) (params : list ValueExpression) :  ValueSequence + Exception :=
...
Definition eval_logical (fname : string) (params : list ValueExpression) : ValueSequence + Exception :=
match convert_string_to_code fname, params with
(** logical and *)
| BAnd, [a; b] => 
   match a, b with
...
Definition eval_equality (fname : string) (params : list ValueExpression) : ValueSequence + Exception :=
match convert_string_to_code fname, params with
...
Fixpoint is_shallow_proper_list (v : ValueExpression) : bool :=
match v with
| VNil => true
...
Fixpoint eval_append (v1 v2 : ValueExpression) : ValueSequence + Exception :=
match v1, v2 with
| VNil, x => inl [x]
...
Definition transform_tuple (v : ValueExpression) : ValueSequence + Exception :=
match v with
...
Fixpoint transform_list (v : ValueExpression) : list ValueExpression + Exception :=
match v with
| VNil      => inl []
...
Definition eval_list_tuple (fname : string) (params : list ValueExpression) : ValueSequence + Exception :=
match convert_string_to_code fname, params with
...
Definition eval_length (params : list ValueExpression) : ValueSequence + Exception :=
match params with
| [v] => let res :=
...
Definition eval_tuple_size (params : list ValueExpression) : ValueSequence + Exception :=
match params with
...
Definition eval_hd_tl (fname : string) (params : list ValueExpression) : ValueSequence + Exception :=
match convert_string_to_code fname, params with
| BHd, [VCons x y] => inl [x]
...
Definition eval_elem_tuple (fname : string) (params : list ValueExpression) : ValueSequence + Exception :=
match convert_string_to_code fname, params with
...
Definition eval_check (fname : string) (params : list ValueExpression) : ValueSequence + Exception := 
match convert_string_to_code fname, params with
...
Definition eval_error (fname : string) (params : list ValueExpression) : Exception :=
match params with
...
Definition eval (fname : string) (params : list ValueExpression) (eff : SideEffectList) 
   : ((ValueSequence + Exception) * SideEffectList) :=
...
Proposition plus_comm_basic {e1 e2 t : ValueExpression} {eff : SideEffectList} : 
...
Proposition plus_comm_basic_value {e1 e2 v : ValueExpression} (eff eff2 : SideEffectList) : 
...
(*TODO: Not working*)
(*
Proposition plus_comm_extended {e1 e2 : ValueExpression} (v : ValueSequence + Exception) (eff eff2 : SideEffectList) : 
...
Proposition plus_effect_unmodified {e1 e2 : ValueExpression} (v' : ValueSequence + Exception) (eff eff2 : SideEffectList) :
...
Proposition plus_effect_changeable {v1 v2 : ValueExpression} (v' : ValueSequence + Exception) (eff eff2 : SideEffectList) :
